...
class CDCLRawSolver:
    ...
    def run(self):
        ...
        # We printed the values of the clauses for debugging purposes

        #print("printing self assigned values")
        #print(self.assigns)
        #print("printing self assigned items")
        #print(self.assigns.items())
